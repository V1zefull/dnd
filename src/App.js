...
const DATA = [
  {
    ...
    name: "Пятёрочка",
    items: [
      { id: "26fd50b3-3841-496e-8b32-73636f6f4197", name: "10% Сливки" },
      { id: "b0ee9d50-d0a6-46f8-96e3-7f3f0f9a2525", name: "Масло" },
    ],
    tint: 1,
  },
  {
    ...
    items: [
      ...
      { id: "5bee94eb-6bde-4411-b438-1c37fa6af364", name: "Провод lightning" },
    ],
    tint: 2,
  },
  {
    ...
    name: "KFC",
    items: [
      { id: "960cbbcf-89a0-4d79-aa8e-56abbc15eacc", name: "Баскет дуэт" },
      { id: "d3edf796-6449-4931-a777-ff66965a025b", name: "18 открых крыльев" },
    ],
    tint: 3,
  },
];
                ...
                <div {...provided.droppableProps} ref={provided.innerRef}>
                  {stores.map((store, index) => (
                      <Draggable draggableId={store.id} key={store.id} index={index}>
                        {(provided) => (
                            <div className="list-container" {...provided.dragHandleProps} {...provided.draggableProps} ref={provided.innerRef}>
                              <StoreList {...store}/>
                            </div>
                        )}
                      </Draggable>
